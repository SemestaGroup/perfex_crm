...
class Accounting_model extends App_Model
{
    ...
    public function get_banks_list()
    {
        ...
        return $this->db->get(db_prefix() . 'acc_accounts')->result_array();
    }

    public function get_transfers_from_bank($id)
    {
        $this->db->where('transfer_funds_to', $id);
        return $this->db->get(db_prefix() . 'acc_transfers')->result_array();
    }
}
