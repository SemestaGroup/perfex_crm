...
function app_init_admin_sidebar_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('deliveries', [
        'collapse' => true,
        'name'     => _l('deliveries'),
        'position' => 15,
    ...
    if (staff_can('view',  'expeditions_list') || staff_can('view_own',  'expeditions_list')) {
        $CI->app_menu->add_sidebar_children_item('deliveries', [
            'slug'     => 'expeditions_list',
            'name'     => _l('expeditions_list'),
            'href'     => admin_url('expeditions'),
            'position' => 10,
            'badge'    => [],
        ]);
    }
    if (staff_can('view',  'cities_list') || staff_can('view_own',  'cities_list')) {
        $CI->app_menu->add_sidebar_children_item('deliveries', [
            'slug'     => 'cities_list',
            'name'     => _l('cities_list'),
            'href'     => admin_url('cities'),
            'position' => 15,
            'badge'    => [],
        ]);
    }
    if (staff_can('view',  'delivering_list') || staff_can('view_own',  'delivering_list')) {
        $CI->app_menu->add_sidebar_children_item('deliveries', [
            'slug'     => 'delivering_list',
            'name'     => _l('delivering_list'),
            'href'     => admin_url('delivering'),
            'position' => 20,
            'badge'    => [],
        ]);
    }
