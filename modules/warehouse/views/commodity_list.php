                  ...
                  <div role="tabpanel" class="tab-pane active" id="interview_infor">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                    <?php
                                    $attr = array();
                                    $attr = ['data-type' => 'number', 'onchange' => 'convertWeightOnChange(this)'];
                                    echo render_input('weight', 'Weight','', 'text', $attr); ?>
                              </div>
                              <input type="hidden" name="weight_in_grams" id="weight_in_grams" value="">
                            </div>
