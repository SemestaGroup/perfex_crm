...
?>
            ...
            <table class="table text-right">
                <tbody>
                    <tr id="weight">
                        <td>
                            <span
                                class="bold tw-text-neutral-700"><?= _l('weight_estimation'); ?>
                                :</span>
                        </td>
                        <td class="weight_est">
                        </td>
                    ...
                    <tr id="shipping">
                        <td>
                            <span
                                class="bold tw-text-neutral-700"><?= _l('shipping_cost_est'); ?>
                                :</span>
                        </td>
                        <td class="shipping_est">
                        </td>
                    </tr>
                    <tr id="subtotal">
                        <td>
    ...
    <div class="panel-body">
        ...
        <?= render_textarea('terms', 'staff_note', $value, [], [], 'mtop15'); ?>
    </div>
